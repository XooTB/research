...
**Status:** **Active workstream** — tracked in `research/os-hgsoc/workstream.md` (since 27 Aug 2026). Data in hand (except GSE9891). First attempt already run; external performance is weak.
