...
refs: T006, E003, F012, D006
tags: validation, reporting, independence
T006 confirmed 26-41 of GSE17260's 110 patients are also in GSE32062 (F012). E003's computed verdict stands (the rule was applied to the rows as recorded, and the ledger entry is unchanged), but the write-up counts independent external cohorts as GSE32062, GSE53963, GSE140082, GSE49997, with GSE17260 reported as a partially redundant sensitivity result rather than a second replication. Sensitivity re-aggregation of the recorded rows (DerSimonian-Laird, no re-scoring): pooled dC without GSE17260 = +0.030 [+0.007, +0.052], I2=0.27, vs +0.036 [+0.010, +0.061] with it, so the direction survives. Independent-replication claims therefore rest on GSE32062 (+0.047 [0.021, 0.071]) plus GSE49997 (+0.044 [-0.022, 0.108], immature follow-up). Any cohort added to os-validation from now on is checked for patient overlap against the existing validators (clinical fingerprint + expression best-match, agent/experiments/t006_*) before it is scored. Rejected: dropping GSE17260 from the library (its numbers are valid, just redundant); re-scoring a de-duplicated GSE17260 (would spend a ledger scoring to answer a question the sensitivity analysis already answers).
